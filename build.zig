...
pub fn build(b: *std.Build) !void {
    ...
    const v4_example = addExample(b, target, uuid_module, "v4-example", "examples/uuid_v4.zig");
    const v7_example = addExample(b, target, uuid_module, "v7-example", "examples/uuid_v7.zig");
    ...
    const run_bench = addBenchmark(b, target, uuid_module, "bench", "bench/main.zig");
    if (b.args) |args| {
